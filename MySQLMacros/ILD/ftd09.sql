...
--
-- Current Database: `ftd09`
--

DROP DATABASE if exists `ftd09`;

CREATE DATABASE  `ftd09`;
...
CREATE TABLE `disks` (
  ...
  `petal_support_zoffset` double DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `disks` VALUES (1,0,0.02,76.67,10,5,6,118.46,1,0,0.1,2,1.5),(2,0.158004,0.02,76.67,10,5,6,118.46,1,0,0.1,2,1.5),(3,0.274428,0.2,122.49,10,5,6,118.46,2,0,0.1,2,1.5),(4,0.445156,0.2,122.49,10,5,6,118.46,2,0,0.1,2,1.5),(5,0.615884,0.2,122.49,10,5,6,118.46,2,0,0.1,2,1.5),(6,0.786611,0.2,122.49,10,5,6,118.46,2,0,0.1,2,1.5),(7,0,0.2,122.49,10,5,6,118.46,2,0,0.1,2,1.5);
...
-- Dump completed on 2011-08-03 15:06:53
