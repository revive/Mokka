...
namespace gear {
	...
	matNames.clear() ;  // fg: need to clear static vector

	CGAGetStepsForJava(volNames,matNames,distance,x,y,z,nbX0,nInterLen);
                                                                                

// 	cout <<  "  CGAGearDistanceProperties::getMaterialNames " << matNames.size() << " , " << distance.size()  << endl ;
	...
	distance.clear() ; // fg: need to clear static vector

	CGAGetStepsForJava(volNames,matNames,distance,x,y,z,nbX0,nInterLen);
                                                                                
// 	cout <<  "  CGAGearDistanceProperties::getMaterialThicknesses " << matNames.size() << " , " << distance.size()  << endl ;
