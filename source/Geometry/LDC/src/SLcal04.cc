 ...
 *
$Id: SLcal04.cc 23 2009-12-17 11:35:56Z bogdan $
 * SLcal01.cc - v1.0 Nov. 2006
 * SLcal02.cc - v1.1 Oct. 2008
 * SLcal04.cc - v1.3 Oct. 2009
 *
 * Version history:
...
SLcal04::SLcal04() : VSuperSubDetectorDriver("SLcal04")
{
...
G4bool SLcal04::PreLoadScriptAction(Database* dbtmp,
...
//  G4cout << "SLcal04::PreLoadScriptAction() done." << G4endl;
  return true;
}


G4bool SLcal04::PostLoadScriptAction(Database*  dbtmp,
			     CGAGeometryEnvironment& )
{
  ...
  G4cout << "SLcal04 has set the following values :" << G4endl 
