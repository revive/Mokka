...
//*******************************************************
//
// $Id: SEcal02.cc,v 1.11 2008/02/11 17:14:47 mora Exp $
// $Name: mokka-07-00 $
//
// 
//
		    ...
		    G4LogicalVolume *theWorld)
{
  ...
  theBarrelSD=0;
  theEndCapSD=0;
  G4cout << "\nBuilding Ecal- SEcal02"<< G4endl;
  G4cout << "*********************************************** *\n"
	 << "*                                               *\n"
	 << "* WARNING: the hits in the end caps are wrong   *\n"
	 << "* with this Ecal driver. You should not use it! *\n"
	 << "*                                               *\n"
	 << "*********************************************** *\n"
	 << G4endl;

  // Initialize the Geant3 interface
  if(Control::DUMPG3) MyPlacement::Init("ECAL","SEcal02");
...
G4bool 
SEcal02::Setup(const CGAGeometryEnvironment &theGeometryEnvironment)
{
  ...
  if((total_number_of_layers % 2) == 0)
    Control::Abort("SEcal02: total number of layers has to be odd!",MOKKA_ERROR_BAD_GLOBAL_PARAMETERS);
...
G4bool SEcal02::Build(G4LogicalVolume* WorldLog)
{
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
void 
SEcal02::BarrelStandardModule(G4LogicalVolume* MotherLog)
{
...
//~              EndcapStandardModule                 ~
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
G4LogicalVolume* SEcal02::EndcapStandardModule(G4bool Zminus)
{
...
void 
SEcal02::EndcapRadiatorPlates(G4LogicalVolume*& EndCapRadiatorL1,
...
void 
SEcal02::LoadEvent(FILE* theSubDetectorEventHitsFileInput)
{
...
G4double 
SEcal02::GiveMeRadiatorThickness(G4int layer_id)
{
...
G4LogicalVolume* 
SEcal02::BuildRadiatorPlate(G4double radiator_dim_x,
			    G4double radiator_dim_y,
			    G4double radiator_dim_z)
{
  // Radiator solid
...
G4LogicalVolume* 
SEcal02::BuildSlab(G4double slab_dim_x,
		   G4double slab_dim_y,
		   G4double slab_dim_z,
		   SEcalSD02 * theSD)
{
...
void
SEcal02::BuildECRingAlveolus (G4int layer_id,
			      G4double z_floor,
...
G4double 
SEcal02::BuildECAlveolus (G4int layer_id,
			  G4double z_floor,
			  G4LogicalVolume* ECLog,
			    G4bool Zminus)
{
...
G4bool 
SEcal02::PostConstructAction(CGAGeometryEnvironment& theGeometryEnvironment)
{
