...
//*******************************************************
//
// $Id: SVxd03.cc,v 1.1 february 2008 grandjean 
...
G4bool 
SVxd03::PreLoadScriptAction(Database* dbtmp,
...
//}
  ...
  G4String vxd05tmp;
  vxd05tmp = G4UIcommand::ConvertToString(theGeometryEnvironment.GetParameterAsDouble("VXD_support_ladder_thickness")/2.);

  query = "update layers_common_parameters set " ; 
  query +=  "support_structure_thickness = " + vxd05tmp + " ;" ;
  dbtmp->exec(query.data());
...
G4bool 
SVxd03::PostLoadScriptAction(Database*  dbtmp,
...
//   //
  ...
  G4cout << "SVxd03 PostLoadScriptAction set radius of first layer to  " 
  ...
  G4cout << "SVxd03 PostLoadScriptAction set radius of last layer to  " 
 	 << dbtmp->fetchDouble("layer_radius") 
	 << G4endl;
  ...
  G4cout << "SVxd03 PostLoadScriptAction the layer gap is   " 
