 ...
 * 
 * FTD_SS_cepc0.hh - driver class header
 * 
 * based on the FTD_Simple_Staggered.hh
 * Xun Chen (chenxun@sjtu.edu.cn) Aug 14, 2014
 */

#ifndef FTD_SS_cepc0_h
#define FTD_SS_cepc0_h 1
...
class FTD_SS_cepc0 : public VSubDetectorDriver
{
public:
    FTD_SS_cepc0(void) : VSubDetectorDriver("FTD_SS_cepc0","ftd")  {} 
    ~FTD_SS_cepc0(void) {};
