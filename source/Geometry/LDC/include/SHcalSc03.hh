...
/** @class SHcalSc03 SHcalSc03.hh "SHcalSc03.hh" 
    ...
    -> LC-TOOL-2008-001
*/
class SHcalSc03 : public VSubDetectorDriver
{
public:
  
  /**Constructor
   */
  SHcalSc03() : VSubDetectorDriver("SHcalSc03","hcal"),
		theBarrilRegSD(0),
		theENDCAPEndSD(0),
...
private:
  ...
  */
  ...
  SDAHcalEndCap     *theENDCAPEndSD;  /**<sensitive detector of the HCAL endcaps in the Tesla design*/
...
const double SHcalSc03::eps = 0.0000001;
