...
//*******************************************************
//
// $Id: Proto04_01.cc,v 1.7 2009/02/11 13:32:46 musat Exp $
// $Name: mokka-07-00 $
//
//
// Proto04_01.cc
...
INSTANTIATE(Proto04_01)

G4bool Proto04_01::ContextualConstruct(
...
G4bool Proto04_01::construct(const G4String &aSubDetectorName,
			  G4LogicalVolume *WorldLog)

{
  G4cout << "\nBuilding Proto release 04_01" << G4endl;
  ...
  if (HalfEcalX <= HalfDeadWX * 3) {
	G4cout << "======= ASSERT WILL CRASH :\n"
		...
		<< HalfEcalX * 2 << G4endl;
        Control::Abort("Proto04_01::construct: Assertion failed (HalfEcalX <= HalfDeadWX * 3)",MOKKA_OTHER_ERRORS);
  }
#endif
  ...
  if (HalfDeadWZ  > HalfEcalZ) {
	G4cout << "======= ASSERT WILL CRASH :\n"
		...
		<< G4endl;
        Control::Abort("Proto04_01::construct: Assertion failed (HalfDeadWZ  > HalfEcalZ)",MOKKA_OTHER_ERRORS);
  }
#endif
...
void Proto04_01::BuildStructures(void) {
...
for (unsigned int i_group=0;i_group<PlateGroups.size();i_group++) {
  ...
  EnvStructureLogical->SetVisAttributes(VisAttAir);
    ...
    if (HalfEnvStructX < HalfEcalX) {
		...
		<< " in the X direction\n" << G4endl;
        Control::Abort("Proto04_01::BuildStructures: Assertion failed (HalfEnvStructX < HalfEcalX)",MOKKA_OTHER_ERRORS);
    }
#endif
...
void Proto04_01::DefineMaterial(void) {
...
Proto04_01::~Proto04_01()
{
//   if(theProtoSD!=0) delete theProtoSD;
}

void Proto04_01::BuildElements() 
{
  //---------------------------------
  ...
  if ((HalfWSlabX > HalfAlveolusX) || (HalfWSlabZ > (HalfAlveolusZ - al_thickness))) {
	G4cout << "======= ASSERT WILL CRASH :\n"
		...
		<< " in the X-Y plane\n" << G4endl;
        Control::Abort("Proto04_01::BuildElements: Assertion failed ((HalfWSlabX > HalfAlveolusX) || (HalfWSlabZ > (HalfAlveolusZ - al_thickness)))",MOKKA_OTHER_ERRORS);
  }
#endif
...
void Proto04_01::BuildDeadPlate(WLAYERS* aPlate)
{
  //-----------------------------------
...
void Proto04_01::CalculateSlabShifts(void) {
...
void Proto04_01::BuildAlveola(WLAYERS* aPlate) {
...
void Proto04_01::FillAlveola(WLAYERS* aPlate, G4LogicalVolume * CFCenterLogical,
				G4LogicalVolume * CFRightLogical) {
  ...
  if (check < 0.) {
	G4cout << "======= ASSERT WILL CRASH :\n"
		...
		<< G4endl;
        Control::Abort("Proto04_01::FillAlveola: Assertion failed (check < 0.) (ID 1)",MOKKA_OTHER_ERRORS);
  }
#endif
  ...
  if(check < 0.) {
	G4cout << "======= ASSERT WILL CRASH :\n"
		...
		<< G4endl;
        Control::Abort("Proto04_01::FillAlveola: Assertion failed (check < 0.) (ID 2)",MOKKA_OTHER_ERRORS);
  }
#endif
...
void Proto04_01::PlaceWafers(G4LogicalVolume * motherTop, 
...
void  
Proto04_01::BeginOfEventAction(const G4Event*)
{
  Dumped=false;
}

void 
Proto04_01::EndOfEventAction(const G4Event* evt)
{
  if(!Dumped) 
