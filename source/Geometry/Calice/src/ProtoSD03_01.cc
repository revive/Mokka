...
//*******************************************************
//
// $Id: ProtoSD03_01.cc,v 1.1 2008/03/12 13:23:04 musat Exp $
// $Name: mokka-07-00 $
//
#include "Control.hh"
...
ProtoSD03_01:: ProtoSD03_01(G4double dimX,G4double dimZ, G4int n_cell_x, 
		...
		G4double lateralWaferGap, G4double endcap_x, 
	        ...
	        G4bool useID1)
: VSensitiveDetector(ProtoSD03_01name), CalCollection(0),
    ...
    theCenterYLayerShifts(centerYLayerShifts),
    theRightYLayerShifts(rightYLayerShifts)
{
  assert (theDimX > 0);
  assert (theDimZ > 0);

  G4String CollName=ProtoSD03_01name+"Collection";
...
ProtoSD03_01::~ProtoSD03_01()
{
}

void ProtoSD03_01::Initialize(G4HCofThisEvent *)
{
...
cell_ids ProtoSD03_01::GetCellIndex(double X, double Y, double Z, 
...
void ProtoSD03_01::GetNearestCell(const G4VTouchable * theTouchable,
  ...
  if (zone < 0) {
	  G4cout << " I: " << I << " J: " << J << " WIWJ: " << 
		 ...
		 " delta_x: " << delta_x << " delta_z: " << 
          ...
          Control::Abort("ProtoSD03_01::GetNearestCell: Assertion failed (zone < 0)");
  }
#endif
*/
...
void ProtoSD03_01::GetCellIndices(const G4VTouchable * theTouchable,
...
G4ThreeVector ProtoSD03_01::GetCellCenter(G4int,G4int WI,G4int WJ,
...
G4bool ProtoSD03_01::ProcessHits(G4Step *aStep,G4TouchableHistory *) {
  ...
  if (distCenter.mag() > (theDimX + theDimZ) / 2.) {
	...
	<< ", distCenter.mag() = " << distCenter.mag() << G4endl;
        Control::Abort("ProtoSD03_01::ProcessHits: Assertion failed (distCenter.mag() > (theDimX + theDimZ) / 2.)",MOKKA_OTHER_ERRORS);
  }
#endif
...
void ProtoSD03_01::EndOfEvent(G4HCofThisEvent*HCE)
{
  if(HCID<0)
...
void ProtoSD03_01::clear()
{
} 

void ProtoSD03_01::DrawAll()
{
} 

void ProtoSD03_01::PrintAll()
{
} 

void ProtoSD03_01::LoadEvent(FILE* theSubDetectorEventHitsFileInput)
{
