...
//*******************************************************
//
// $Id: Proto05.hh,v 1.2 2008/12/03 16:13:30 musat Exp $
// $Name: mokka-07-00 $
//
#ifndef Proto05_h
#define Proto05_h 1
...
class Proto05 : public VSubDetectorDriver
{
public:
  Proto05() : VSubDetectorDriver("proto05","proto"),
...
private:
  ...
  void BuildAlveolaEnveloppe(WLAYERS*, G4int);
  void BuildInstrumentedCenterAlveola(WLAYERS*);
  void BuildInstrumentedRightAlveola(WLAYERS*);
  void BuildWAlveola(WLAYERS*, char);
  void FillCenterAlveola(WLAYERS*, G4LogicalVolume *);
  void FillRightAlveola(WLAYERS*, G4LogicalVolume *);
  void PlaceWafers(G4LogicalVolume *, G4LogicalVolume *,
	            G4LogicalVolume *, G4LogicalVolume *,
		    G4double, G4double, G4double, G4int, G4int);
  void FillSlabPatternVector(void);
...
G4String slabConfigPattern;
std::vector<G4int> slabConfig;
