...
//*******************************************************
//
// $Id: Proto04_02.hh,v 1.2 2008/12/03 16:13:30 musat Exp $
// $Name: mokka-07-00 $
//
#ifndef Proto04_02_h
#define Proto04_02_h 1
...
class Proto04_02 : public VSubDetectorDriver
{
public:
  Proto04_02() : VSubDetectorDriver("proto04_02","proto"),
...
private:
  ...
  void BuildAlveola(WLAYERS*, unsigned int);
  void FillAlveola(WLAYERS*,G4LogicalVolume *,G4LogicalVolume *,unsigned int);
...
ProtoSD03_01* theCellProtoSD;
ProtoSD03_01* theGRProtoSD;
