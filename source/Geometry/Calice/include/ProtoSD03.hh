...
//*******************************************************
//
// $Id: ProtoSD03.hh,v 1.4 2006/03/01 14:13:30 musat Exp $
// $Name: mokka-07-00 $
//

#ifndef ProtoSD03_h
#define ProtoSD03_h 1
...
class ProtoSD03 : public VSensitiveDetector
{
  
public:
  ProtoSD03(G4double dimX,G4double dimZ, G4int n_cell_x, G4int n_cell_z,
	  ...
	  G4String ProtoSD03name, G4int start_layer_number,
	  ...
	  G4double lateralWaferGap, G4double endcap_x, G4bool useID1=false);
  virtual ~ProtoSD03();
