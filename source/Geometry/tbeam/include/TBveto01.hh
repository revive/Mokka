...
class TBveto01 : public VSubDetectorDriver
{
public:
  TBveto01() : VSubDetectorDriver("TBveto01","TBveto"),
	       db(0)
  {}
...
private:
  ...
  G4double ncell_xy[4];
  G4double x_place1, y_place1, x_place2, y_place2, x_place3, y_place3, x_place4, y_place4;
  G4double z_place1;
  ...
  G4LogicalVolume *SteelFrontLogical, *SteelBackLogical, *HoleLogicalSci, *HoleLogicalFW, *HoleLogicalBW;
