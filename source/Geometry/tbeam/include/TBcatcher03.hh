// $Header: /home/flc/cvs/Mokka/source/Geometry/tbeam/include/TBcatcher03.hh,v 1.5 2004/10/25 17:27:31 jeremy Exp $

#ifndef TBcatcher03_h
#define TBcatcher03_h 1
...
class TBcatcher03 : public VSubDetectorDriver
{
...
private:
  ...
  // build subfunctions
  G4bool BuildCatcher();
  G4LogicalVolume* BuildCoarseLayerLogical();
  G4LogicalVolume* BuildFineLayerLogical();
...
private:
  ...
  G4LogicalVolume *FineLayerLogical,
    *CoarseLayerLogical;

  // material pointers
  G4Material *steel, *poly, *tyvek;
