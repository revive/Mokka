// $Header: /home/flc/cvs/Mokka/source/Geometry/tbeam/include/TBSD_VCell03.hh,v 1.6 2009/02/27 14:45:57 musat Exp $

#ifndef TBSD_VCell03_h
#define TBSD_VCell03_h 1
...
class TBSD_VCell03 : public VSensitiveDetector
{

public:

  TBSD_VCell03(G4String sdname,   // name of SD
...
private:
  ...
  G4bool FindHit(G4int, G4double, G4int pdg , G4double time, float* sp);
