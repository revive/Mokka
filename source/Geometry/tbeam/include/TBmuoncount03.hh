#ifndef TBmuoncount03_h
#define TBmuoncount03_h 1
...
class TBmuoncount03 : public VSubDetectorDriver
{
public:
  TBmuoncount03() : VSubDetectorDriver("TBmuoncount03","TBmuoncount"),
	       db(0)
  {}
...
private:
  ...
  G4double config_angle, translateX, translateY, z_end_tcmt;
  G4int nslice;
