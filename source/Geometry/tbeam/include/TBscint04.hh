...
class TBscint04 : public VSubDetectorDriver
{
public:
  TBscint04() : VSubDetectorDriver("TBscint04","TBscint"),
	       db(0)
  {}
...
private:
  ...
  void FetchAll();
  void BuildElements(G4double xdim, G4double ydim, G4int idsc);
