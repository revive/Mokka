...
INSTANTIATE(TBmuoncount04_01)

TBmuoncount04_01::~TBmuoncount04_01()
{}

G4bool TBmuoncount04_01::ContextualConstruct(const CGAGeometryEnvironment &aGeometryEnvironment,
                  G4LogicalVolume *theWorld)
{
 ...
 G4cout << "\nBuilding TBmuoncount04_01..." << G4endl;
 ...
 G4cout << "\nDone building TBmuoncount04_01" << G4endl;
 return doMC;

}

G4bool TBmuoncount04_01::SciConstruct(G4LogicalVolume *WorldLog, G4double xdim, G4double ydim,
...
void TBmuoncount04_01::FetchAll()
{
  ...
  z_place1 = db->fetchDouble("z_place1");		//  - 4041 mm
  z_place2 = db->fetchDouble("z_place2");		//    4747 mm
  ...
  sci_hthickness = db->fetchDouble("mc_thickness");            // 18 mm
  sci_window = db->fetchDouble("steel_thickness");             //  1 mm

  Print();
}

void TBmuoncount04_01::BuildElements(G4double xdim, G4double ydim)
{
...
G4bool TBmuoncount04_01::BuildSci(G4double x_place, G4double y_place, G4double z_place,
			   G4int idsc)
{
...
void TBmuoncount04_01::SetSD(G4int idch)
{
...
void TBmuoncount04_01::SetDepthToLayer(G4int i) {
  depthToLayer = i;
  G4cout <<" DepthToLayer in Muon Counter: " << depthToLayer << G4endl;
}

void TBmuoncount04_01::Print()
{
  G4cout << "\nTBmuoncount04_01 information: " << G4endl
