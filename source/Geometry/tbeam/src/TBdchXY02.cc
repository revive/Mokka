...
INSTANTIATE(TBdchXY02)
  
  TBdchXY02::~TBdchXY02()
{}

G4bool TBdchXY02::ContextualConstruct(const CGAGeometryEnvironment &aGeometryEnvironment,
				      G4LogicalVolume *theWorld)
{
  ...
  G4bool doDchX1 = DchConstruct (theWorld,x_placeX1,y_placeX1,z_placeX1,1);
  G4bool doDchY1 = DchConstruct (theWorld,x_placeY1,y_placeY1,z_placeY1,2);
  G4bool doDch1 = false;
  if (doDchX1 && doDchY1) doDch1 = true;

  G4bool doDchX2 = DchConstruct (theWorld,x_placeX2,y_placeX2,z_placeX2,3);
  G4bool doDchY2 = DchConstruct (theWorld,x_placeY2,y_placeY2,z_placeY2,4);
  G4bool doDch2 = false;
  if (doDchX2 && doDchY2) doDch2 = true;

  G4bool doDchX3 = DchConstruct (theWorld,x_placeX3,y_placeX3,z_placeX3,5);
  G4bool doDchY3 = DchConstruct (theWorld,x_placeY3,y_placeY3,z_placeY3,6);
  G4bool doDch3 = false;
  if (doDchX3 && doDchY3) doDch3 = true;

  G4bool doDchX4 = DchConstruct (theWorld,x_placeX4,y_placeX4,z_placeX4,7);
  G4bool doDchY4 = DchConstruct (theWorld,x_placeY4,y_placeY4,z_placeY4,8);
  G4bool doDch4 = false;
  ...
  G4cout << "\nDone building TBdchXY02" << G4endl;

  return doDch;
  
}

G4bool TBdchXY02::DchConstruct(G4LogicalVolume *WorldLog, 
			       ...
			       G4int idch)
{
  ...
  if (idch%2 == 1) cokay = BuildDchX(x_place, y_place, z_place, idch);
  if (idch%2 == 0) cokay = BuildDchY(x_place, y_place, z_place, idch);
  
  return cokay;
}

void TBdchXY02::FetchAll()
{
  ...
  x_placeX1 = translateX + (ecal_front_face + z_placeX1)*sin(config_angle);
  y_placeX1 = translateY;
  z_placeX1 = (ecal_front_face + z_placeX1)*cos(config_angle);
  
  x_placeX2 = translateX + (ecal_front_face + z_placeX2)*sin(config_angle);
  y_placeX2 = translateY;
  z_placeX2 = (ecal_front_face + z_placeX2)*cos(config_angle);
  
  x_placeX3 = translateX + (ecal_front_face + z_placeX3)*sin(config_angle);
  y_placeX3 = translateY;
  z_placeX3 = (ecal_front_face + z_placeX3)*cos(config_angle);
  
  x_placeX4 = translateX + (ecal_front_face + z_placeX4)*sin(config_angle);
  y_placeX4 = translateY;
  z_placeX4 = (ecal_front_face + z_placeX4)*cos(config_angle);
  
  x_placeY1 = translateX + (ecal_front_face + z_placeY1)*sin(config_angle);
  y_placeY1 = translateY;
  z_placeY1 = (ecal_front_face + z_placeY1)*cos(config_angle);
  
  x_placeY2 = translateX + (ecal_front_face + z_placeY2)*sin(config_angle);
  y_placeY2 = translateY;
  z_placeY2 = (ecal_front_face + z_placeY2)*cos(config_angle);
  
  x_placeY3 = translateX + (ecal_front_face + z_placeY3)*sin(config_angle);
  y_placeY3 = translateY;
  z_placeY3 = (ecal_front_face + z_placeY3)*cos(config_angle);
  
  x_placeY4 = translateX + (ecal_front_face + z_placeY4)*sin(config_angle);
  y_placeY4 = translateY;
  z_placeY4 = (ecal_front_face + z_placeY4)*cos(config_angle);
...
G4bool TBdchXY02::BuildDchX(G4double x_place, G4double y_place, G4double z_place, G4int idch)
{
...
G4bool TBdchXY02::BuildDchY(G4double x_place, G4double y_place, G4double z_place, G4int idch)
{                                     
...
void TBdchXY02::SetSD(G4int idch)
{
...
void TBdchXY02::SetDepthToLayer(G4int i) {
  depthToLayer = i;
  G4cout <<" DepthToLayer in Dch: " << depthToLayer << G4endl;
}

void TBdchXY02::Print()
{
  G4cout << "\nTBdchXY02 information: " << G4endl
