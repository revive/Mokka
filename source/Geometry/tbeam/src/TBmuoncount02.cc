...
// muon counters in the Oct06 CERN06 setup #
//                                         #
//##########################################

#include "TBmuoncount02.hh"
...
INSTANTIATE(TBmuoncount02)

TBmuoncount02::~TBmuoncount02()
{}

G4bool TBmuoncount02::ContextualConstruct(const CGAGeometryEnvironment &aGeometryEnvironment,
                  G4LogicalVolume *theWorld)
{
 ...
 G4cout << "\nDone building TBmuoncount02" << G4endl;
 return doMC;

}

G4bool TBmuoncount02::SciConstruct(G4LogicalVolume *WorldLog, G4double xdim, G4double ydim,
...
void TBmuoncount02::BuildElements(G4double xdim, G4double ydim)
{
...
G4bool TBmuoncount02::BuildSci(G4double x_place, G4double y_place, G4double z_place,
			   G4int idsc)
{
...
void TBmuoncount02::SetSD(G4int idch)
{
...
void TBmuoncount02::SetDepthToLayer(G4int i) {
  depthToLayer = i;
  G4cout <<" DepthToLayer in Muon Counter: " << depthToLayer << G4endl;
}

void TBmuoncount02::Print()
{
  G4cout << "\nTBmuoncount02 information: " << G4endl
