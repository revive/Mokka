...
INSTANTIATE(TBhcal05_01)

TBhcal05_01::TBhcal05_01() : VSubDetectorDriver("TBhcal05_01","TBhcal"),
		       db(0),
...
TBhcal05_01::~TBhcal05_01()
{}

//G4bool TBhcal05_01::construct(const G4String &aSubDetectorDBName,
//			   G4LogicalVolume *WorldLog)
G4bool TBhcal05_01::ContextualConstruct(const
    CGAGeometryEnvironment &aGeometryEnvironment,
    G4LogicalVolume *WorldLog)
{
  G4cout << "\nBuilding TBhcal05_01..." << G4endl;
  ...
  G4cout << "\nDone building TBhcal05_01" << G4endl;
  
  return cokay;
}

// fetch MySQL variables
void TBhcal05_01::FetchAll()
{
...
void TBhcal05_01::BuildElements()
{
  // hcal dims
  layer_hthickness =
  ...
  foil_3m = TBhcal05_01::Polystyrole;
  pcb = TBhcal05_01::PCB;
  cf_mix = TBhcal05_01::CF_MIX;
...
void TBhcal05_01::PlaceLayer(G4LogicalVolume *WorldLog, G4int nlay)
{
  ...
  */
  ...
  // put in rotation
  G4double fullHCALThickness = n_layers*2.0*layer_hthickness + n_layer_term*2.0*steel_hthickness_term;
  G4double zOfRotationAxis = fullHCALThickness/2.0 + z_begin;
  
  G4double dZRotationAxis = zOfRotationAxis - lay_z;
  
  G4double zDisplacement = dZRotationAxis*cos(rotationAngle);
  
  G4double offsetX = dZRotationAxis*sin(rotationAngle);
  G4double offsetZ = zOfRotationAxis - zDisplacement - lay_z;
  ...
  if (nlay == n_layers) {
    ...
    for (int nterm = 0; nterm < n_layer_term; nterm++) {
      ...
      lay_x = x_begin;
      lay_y = y_begin;
      lay_z = z_begin + layer_hthickness;
	...
	lay_z += layer_hthickness + steel_hthickness_term;
...
void TBhcal05_01::Print()
{
  G4cout << "\nTBhcal05_01 parameters: " << G4endl
...
G4bool TBhcal05_01::isValidSensitiveLayerPattern(G4String sensitiveLayerPattern) {
...
std::vector<G4int> TBhcal05_01::getSensitiveLayerPatternVector(G4String sensitiveLayerPattern) {
...
void TBhcal05_01::buildLayerGeometry1() {
...
void TBhcal05_01::buildLayerGeometry2() {
