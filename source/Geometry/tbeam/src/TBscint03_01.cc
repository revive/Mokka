...
INSTANTIATE(TBscint03_01)

TBscint03_01::~TBscint03_01()
{}

G4bool TBscint03_01::ContextualConstruct(const CGAGeometryEnvironment &aGeometryEnvironment,
                  G4LogicalVolume *theWorld)
{
 ...
 G4bool doSci2 = SciConstruct (theWorld,ncell_xy[0],ncell_xy[1],x_place2,y_place2,z_place2,2); // 100x100 counter

 delete db;
 db = 0;
  
 G4bool doSci = false;
 if (doSci1 && doSci2) doSci = true;

 G4cout << "\nDone building TBscint03_01" << G4endl;
 return doSci;

}

G4bool TBscint03_01::SciConstruct(G4LogicalVolume *WorldLog, G4double xdim, G4double ydim,
...
void TBscint03_01::FetchAll()
{
  ...
  z_place1 = db->fetchDouble("z_place1")*mm;		//  
  z_place2 = db->fetchDouble("z_place2")*mm;		//  
...
void TBscint03_01::BuildElements(G4double xdim, G4double ydim)
{
...
G4bool TBscint03_01::BuildSci(G4double x_place, G4double y_place, G4double z_place,
			   G4int idsc)
{
...
void TBscint03_01::SetSD(G4int idch)
{
...
void TBscint03_01::SetDepthToLayer(G4int i) {
  depthToLayer = i;
  G4cout <<" DepthToLayer in Scintillator: " << depthToLayer << G4endl;
}

void TBscint03_01::Print()
{
  G4cout << "\nTBscint03_01 information: " << G4endl
