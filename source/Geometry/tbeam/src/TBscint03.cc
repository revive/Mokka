...
INSTANTIATE(TBscint03)

TBscint03::~TBscint03()
{}

G4bool TBscint03::ContextualConstruct(const CGAGeometryEnvironment &aGeometryEnvironment,
                  G4LogicalVolume *theWorld)
{
 ...
 G4cout << "\nDone building TBscint03" << G4endl;
 return doSci;

}

G4bool TBscint03::SciConstruct(G4LogicalVolume *WorldLog, G4double xdim, G4double ydim,
...
void TBscint03::FetchAll()
{
  ...
  ncell_xy[0] = db->fetchDouble("sci_dim_x1");		// 100 mm
  ncell_xy[1] = db->fetchDouble("sci_dim_y1");		// 100 mm
...
void TBscint03::BuildElements(G4double xdim, G4double ydim)
{
...
G4bool TBscint03::BuildSci(G4double x_place, G4double y_place, G4double z_place,
			   G4int idsc)
{
...
void TBscint03::SetSD(G4int idch)
{
...
void TBscint03::SetDepthToLayer(G4int i) {
  depthToLayer = i;
  G4cout <<" DepthToLayer in Scintillator: " << depthToLayer << G4endl;
}

void TBscint03::Print()
{
  G4cout << "\nTBscint03 information: " << G4endl
