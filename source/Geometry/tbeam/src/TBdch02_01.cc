...
INSTANTIATE(TBdch02_01)

TBdch02_01::~TBdch02_01()
{}

G4bool TBdch02_01::ContextualConstruct(const CGAGeometryEnvironment &aGeometryEnvironment,
                G4LogicalVolume *theWorld)
{
 ...
 G4cout << "\nDone building TBdch02_01" << G4endl;
 return doDch;

}

G4bool TBdch02_01::DchConstruct(G4LogicalVolume *WorldLog, 
...
void TBdch02_01::FetchAll()
{
  ...
  z_place1 = db->fetchDouble("z_place1");		// 1660mm from ECAL front face
  z_place2 = db->fetchDouble("z_place2");		//  660mm from ECAL front face
  z_place3 = db->fetchDouble("z_place3");		// 2570mm from ECAL front face
  z_place4 = db->fetchDouble("z_place4");		// 3570mm from ECAL front face
...
G4bool TBdch02_01::BuildDch(G4double x_place, G4double y_place, G4double z_place)
{
...
void TBdch02_01::SetSD(G4int idch)
{
...
void TBdch02_01::SetDepthToLayer(G4int i) {
  depthToLayer = i;
  G4cout <<" DepthToLayer in Dch: " << depthToLayer << G4endl;
}

void TBdch02_01::Print()
{
  G4cout << "\nTBdch02_01 information: " << G4endl
