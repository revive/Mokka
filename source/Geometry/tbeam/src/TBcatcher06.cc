// $Header: /home/flc/cvs/Mokka/source/Geometry/tbeam/src/TBcatcher06.cc,v 1.4 2008/01/23 10:16:56 musat Exp $

#include "Control.hh"
#include "TBcatcher06.hh"
...
INSTANTIATE(TBcatcher06)

// #define TCMT_DEBUG

TBcatcher06::~TBcatcher06()
{}

TBcatcher06::TBcatcher06()
  : VSubDetectorDriver("TBcatcher06","TBcatcher"),
    db(0),
...
void TBcatcher06::DefineMaterials()
{
  // materials
...
G4bool TBcatcher06::ContextualConstruct(const CGAGeometryEnvironment &aGeometryEnvironment,
					G4LogicalVolume *WorldLog)
{
  G4cout << G4endl << "\n ======== Driver TBcatcher06 ========" << G4endl;
  ...
  */
  ...
  G4cout << "\n======== Done with driver TBcatcher06 ========" << G4endl;

  return cokay;
}

void TBcatcher06::FetchAll()
{
...
void TBcatcher06::SetDepthToLayer(G4int i) {
  depthToLayer = i;
#ifdef TCMT_DEBUG
...
G4bool TBcatcher06::BuildCatcher()
{
...
G4LogicalVolume* TBcatcher06::BuildCoarseLayerLogical(bool withCassette, G4ThreeVector& offset)
{
...
G4LogicalVolume* TBcatcher06::BuildFineLayerLogical(bool withCassette, G4ThreeVector& offset)
{
  G4LogicalVolume *thisLogical = 0;
...
G4LogicalVolume* TBcatcher06::BuildReadoutModuleLogical()
{
...
G4LogicalVolume* TBcatcher06::BuildCatcherEnvelope()
{
...
void TBcatcher06::BuildCatcherLayers()
{
...
void TBcatcher06::ComputeCalXY()
{
  xlen_tcmt = (ncell_xy[0] * grid_size)/2;
  ylen_tcmt = (ncell_xy[1] * grid_size)/2;
}

void TBcatcher06::ComputeCatcherTransform()
{
#ifdef TCMT_DEBUG
  G4cout << G4endl << "TBcatcher06::ComputeCatcherTransform()" << G4endl;
#endif
...
G4bool TBcatcher06::PostConstructAction(CGAGeometryEnvironment& ){
