...
INSTANTIATE(TBdchY02_01)

TBdchY02_01::~TBdchY02_01()
{}

G4bool TBdchY02_01::ContextualConstruct(const CGAGeometryEnvironment &aGeometryEnvironment,
                G4LogicalVolume *theWorld)
{
  ...
  G4cout << "\nDone building TBdchY02_01" << G4endl;
  return doDch;
  
}

G4bool TBdchY02_01::DchConstruct(G4LogicalVolume *WorldLog, 
...
void TBdchY02_01::FetchAll()
{
  ...
  z_place1 = db->fetchDouble("z_placeY1");		//   28mm from ECAL front face
  z_place2 = db->fetchDouble("z_placeY2");		// 1128mm from ECAL front face
  z_place3 = db->fetchDouble("z_placeY3");		// 2038mm from ECAL front face
  z_place4 = db->fetchDouble("z_placeY4");		// 3138mm from ECAL front face
...
void TBdchY02_01::BuildElements()
{
...
G4bool TBdchY02_01::BuildDch(G4double x_place, G4double y_place, G4double z_place)
{
...
void TBdchY02_01::SetSD(G4int idch)
{
...
void TBdchY02_01::SetDepthToLayer(G4int i) {
  depthToLayer = i;
  G4cout <<" DepthToLayer in Dch: " << depthToLayer << G4endl;
}

void TBdchY02_01::Print()
{
  G4cout << "\nTBdchY02_01 information: " << G4endl
