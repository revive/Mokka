...
G4bool TBdch02::ContextualConstruct(const CGAGeometryEnvironment &aGeometryEnvironment,
                G4LogicalVolume *theWorld)
{
 ...
 G4cout << "\nDone building TBdch02" << G4endl;
 return doDch;

}

G4bool TBdch02::DchConstruct(G4LogicalVolume *WorldLog, 
...
G4bool TBdch02::BuildDch(G4double x_place, G4double y_place, G4double z_place)
{
...
void TBdch02::SetDepthToLayer(G4int i) {
  depthToLayer = i;
