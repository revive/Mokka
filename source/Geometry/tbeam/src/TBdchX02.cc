...
INSTANTIATE(TBdchX02)

TBdchX02::~TBdchX02()
{}

G4bool TBdchX02::ContextualConstruct(const CGAGeometryEnvironment &aGeometryEnvironment,
                G4LogicalVolume *theWorld)
{
 ...
 G4cout << "\nDone building TBdchX02" << G4endl;
 return doDch;

}

G4bool TBdchX02::DchConstruct(G4LogicalVolume *WorldLog, 
...
void TBdchX02::FetchAll()
{
  ...
  z_place1 = db->fetchDouble("z_placeX1");		//  682mm from ECAL front face
  z_place2 = db->fetchDouble("z_placeX2");		// 1782mm from ECAL front face
  z_place3 = db->fetchDouble("z_placeX3");		// 2692mm from ECAL front face
  z_place4 = db->fetchDouble("z_placeX4");		// 3792mm from ECAL front face
...
G4bool TBdchX02::BuildDch(G4double x_place, G4double y_place, G4double z_place)
{
...
void TBdchX02::SetSD(G4int idch)
{
...
void TBdchX02::SetDepthToLayer(G4int i) {
  depthToLayer = i;
