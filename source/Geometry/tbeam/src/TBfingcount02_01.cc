...
INSTANTIATE(TBfingcount02_01)

TBfingcount02_01::~TBfingcount02_01()
{}

G4bool TBfingcount02_01::ContextualConstruct(const CGAGeometryEnvironment &aGeometryEnvironment,
                  G4LogicalVolume *theWorld)
{
 ...
 G4cout << "\nBuilding TBfingcount02_01..." << G4endl;
 ...
 G4cout << "\nDone building TBfingcount02_01" << G4endl;
 return doFC;

}

G4bool TBfingcount02_01::SciConstruct(G4LogicalVolume *WorldLog, G4double xdim, G4double ydim,
...
void TBfingcount02_01::FetchAll()
{
...
void TBfingcount02_01::BuildElements(G4double xdim, G4double ydim)
{
...
G4bool TBfingcount02_01::BuildSci(G4double x_place, G4double y_place, G4double z_place,
			   G4int idsc)
{
...
void TBfingcount02_01::SetSD(G4int idch)
{
...
void TBfingcount02_01::SetDepthToLayer(G4int i) {
  depthToLayer = i;
  G4cout <<" DepthToLayer in Finger Counter: " << depthToLayer << G4endl;
}

void TBfingcount02_01::Print()
{
  G4cout << "\nTBfingcount02_01 information: " << G4endl
