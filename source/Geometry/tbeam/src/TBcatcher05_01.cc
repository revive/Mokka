// $Header: /home/flc/cvs/Mokka/source/Geometry/tbeam/src/TBcatcher05_01.cc,v 1.2 2007/03/05 23:40:40 guilherme Exp $

#include "Control.hh"
#include "TBcatcher05_01.hh"
...
INSTANTIATE(TBcatcher05_01)

TBcatcher05_01::~TBcatcher05_01()
{}

TBcatcher05_01::TBcatcher05_01() 
  : VSubDetectorDriver("TBcatcher05_01","TBcatcher"),
    db(0),
...
void TBcatcher05_01::DefineMaterials()
{
  // materials
...
G4bool TBcatcher05_01::ContextualConstruct(const
    CGAGeometryEnvironment &aGeometryEnvironment,
    G4LogicalVolume *WorldLog)
{
  G4cout << G4endl << "Building TBcatcher05_01..." << G4endl;
  ...
  G4cout << "\nDone building TBcatcher05_01" << G4endl;
  
  return cokay;
}

void TBcatcher05_01::FetchAll()
{
  ...
  config_angle = _aGeometryEnvironment.GetParameterAsDouble ("TCMTRotationAngle");
  ...
  //====
  // config_angle can be used to move the catcher away from hcal, for
  // non-normal incidence of beam into the Hcal.  This feature is not
  // necessary with the new coordinate system, so the config_angle is
  // always set to zero here.  - GL070123
  config_angle = 0.0;
  //====
...
void TBcatcher05_01::SetDepthToLayer(G4int i) {
  depthToLayer = i;
#ifdef TBSD_DEBUG
...
G4bool TBcatcher05_01::BuildCatcher()
{
...
G4LogicalVolume* TBcatcher05_01::BuildCoarseLayerLogical(bool withCassette)
{
...
G4LogicalVolume* TBcatcher05_01::BuildFineLayerLogical(bool withCassette)
{
  G4LogicalVolume *thisLogical = 0;
...
G4LogicalVolume* TBcatcher05_01::BuildReadoutModuleLogical()
{
...
G4LogicalVolume* TBcatcher05_01::BuildCatcherEnvelope()
{
...
void TBcatcher05_01::BuildCatcherLayers()
{
...
void TBcatcher05_01::ComputeCalXY()
{
  cal_hx = (ncell_xy[0] * grid_size)/2;
  cal_hy = (ncell_xy[1] * grid_size)/2;
}

void TBcatcher05_01::ComputeCatcherTransform()
{
  G4cout << G4endl << "TBcatcher05_01::ComputeCatcherTransform()" << G4endl;
  ...
  G4cout <<"translationAdjust effect: "<< G4ThreeVector(x_place, 0, z_place)
...
void TBcatcher05_01::PlaceCatcher()
{
