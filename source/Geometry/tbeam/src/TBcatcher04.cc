// $Header: /home/flc/cvs/Mokka/source/Geometry/tbeam/src/TBcatcher04.cc,v 1.5 2006/05/04 09:52:27 adrian Exp $

#include "Control.hh"
#include "TBcatcher04.hh"
...
INSTANTIATE(TBcatcher04)

TBcatcher04::~TBcatcher04()
{}

TBcatcher04::TBcatcher04() 
  : VSubDetectorDriver("TBcatcher04","TBcatcher"),
    db(0),
...
void TBcatcher04::DefineMaterials()
{
  // materials
  poly = steel = tyvek = 0;
...
G4bool TBcatcher04::ContextualConstruct(const
    CGAGeometryEnvironment &aGeometryEnvironment,
    G4LogicalVolume *WorldLog)
{
  G4cout << G4endl << "Building TBcatcher04..." << G4endl;
  ...
  G4cout << "\nDone building TBcatcher04" << G4endl;
  
  return cokay;
}

void TBcatcher04::FetchAll()
{
...
void TBcatcher04::SetDepthToLayer(G4int i) {
  depthToLayer = i;
#ifdef TBSD_DEBUG
...
G4bool TBcatcher04::BuildCatcher()
{
...
G4LogicalVolume* TBcatcher04::BuildCoarseLayerLogical()
{
...
G4LogicalVolume* TBcatcher04::BuildFineLayerLogical()
{
...
G4LogicalVolume* TBcatcher04::BuildReadoutModuleLogical()
{
...
G4LogicalVolume* TBcatcher04::BuildCatcherEnvelope()
{
  ComputeCalXY();
...
void TBcatcher04::BuildCatcherLayers()
{
...
void TBcatcher04::ComputeCalXY()
{
  cal_hx = (ncell_xy[0] * grid_size)/2;
  cal_hy = (ncell_xy[1] * grid_size)/2;
}

void TBcatcher04::ComputeCatcherTransform()
{
  G4cout << G4endl << "TBcatcher04::ComputeCatcherTransform()" << G4endl;
