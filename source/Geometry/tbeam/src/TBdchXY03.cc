...
INSTANTIATE(TBdchXY03)

TBdchXY03::~TBdchXY03()
{}

G4bool TBdchXY03::ContextualConstruct(const CGAGeometryEnvironment &aGeometryEnvironment,
                G4LogicalVolume *theWorld)
{
 ...
 G4cout << "\nDone building TBdchXY03" << G4endl;
 return doDch;

}

G4bool TBdchXY03::DchConstruct(G4LogicalVolume *WorldLog, 
...
G4bool TBdchXY03::BuildDch(G4double x_place, G4double y_place, G4double z_place, G4int idch)
{
...
void TBdchXY03::SetSD(G4int idch)
{
...
void TBdchXY03::SetDepthToLayer(G4int i) {
  depthToLayer = i;
  G4cout <<" DepthToLayer in Dch: " << depthToLayer << G4endl;
}

void TBdchXY03::Print()
{
  G4cout << "\nTBdchXY03 information: " << G4endl
