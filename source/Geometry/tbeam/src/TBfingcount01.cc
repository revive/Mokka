...
INSTANTIATE(TBfingcount01)

TBfingcount01::~TBfingcount01()
{}

G4bool TBfingcount01::ContextualConstruct(const CGAGeometryEnvironment &aGeometryEnvironment,
                  G4LogicalVolume *theWorld)
{
 ...
 G4cout << "\nDone building TBfingcount01" << G4endl;
 return doFC;

}

G4bool TBfingcount01::SciConstruct(G4LogicalVolume *WorldLog, G4double xdim, G4double ydim,
...
void TBfingcount01::BuildElements(G4double xdim, G4double ydim)
{
...
G4bool TBfingcount01::BuildSci(G4double x_place, G4double y_place, G4double z_place,
			   G4int idsc)
{
...
void TBfingcount01::SetSD(G4int idch)
{
...
void TBfingcount01::SetDepthToLayer(G4int i) {
  depthToLayer = i;
  G4cout <<" DepthToLayer in Finger Counter: " << depthToLayer << G4endl;
}

void TBfingcount01::Print()
{
  G4cout << "\nTBfingcount01 information: " << G4endl
