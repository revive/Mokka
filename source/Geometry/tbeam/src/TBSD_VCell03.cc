// $Header: /home/flc/cvs/Mokka/source/Geometry/tbeam/src/TBSD_VCell03.cc,v 1.7 2009/02/02 11:44:11 angela Exp $
...
TBSD_VCell03::TBSD_VCell03(G4String sdname,
			   G4double gridDim,
			   G4int nCellX,
			   G4int nCellY,
			   G4int dLayer,
...
void TBSD_VCell03::Initialize(G4HCofThisEvent* HCE)
{
#ifdef TBSD_DEBUG
...
G4bool TBSD_VCell03::ProcessHits(G4Step* aStep, G4TouchableHistory*)
{
#ifdef TBSD_DEBUG
  G4cout << G4endl << "TBSD_VCell03::ProcessHits(): " << SDName << G4endl;
#endif
...
G4bool TBSD_VCell03::FindHit(G4int cellId, G4double edep, G4int PDG, G4double globalTime, float* sp )
{
...
void TBSD_VCell03::SetCellID( G4float localPosX, G4float localPosY){
...
void TBSD_VCell03::SetNCellXY(G4int nx, G4int ny) 
{ 
  // set n cell
  ncell_xy[0] = nx; 
  ncell_xy[1] = ny; 
...
void TBSD_VCell03::SetGridDim(G4double g) 
{ 
  gridDim = g; 
}

void TBSD_VCell03::SetDepthToLayer(G4int d) 
{ 
  depthToLayer = d; 
}

void TBSD_VCell03::SetModuleID(G4int m)
{
  moduleID = m;
}

G4int* TBSD_VCell03::GetNCellXY() 
{ 
  // get n cell
  return ncell_xy; 
} 

G4double TBSD_VCell03::GetGridDim() 
{ 
  return gridDim; 
}

G4int TBSD_VCell03::GetDepthToLayer() 
{ 
  return depthToLayer; 
}

G4int TBSD_VCell03::GetApplyBirksLaw() 
{ 
  return applyBirksLaw; 
}

G4double TBSD_VCell03::GetZBeginDetector()
{
  return zBeginDetector;
}

G4double TBSD_VCell03::GetHcalTimeCut()
{
  return hcalTimeCut;
} 

void TBSD_VCell03::EndOfEvent(G4HCofThisEvent* HCE)
{
  TBHitMapIterator iter;
...
G4double TBSD_VCell03::GetBirksAttenuatedEnergy(const G4Step* aStep)
{
