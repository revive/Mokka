...
// chambers in the 2008 FNAL setup    #
//                                    #
//#####################################

#include "TBdchXY05_01.hh"
...
INSTANTIATE(TBdchXY05_01)
  
  TBdchXY05_01::~TBdchXY05_01()
{}

G4bool TBdchXY05_01::ContextualConstruct(const CGAGeometryEnvironment &aGeometryEnvironment,
...
//  ecal_front_face = aGeometryEnvironment.GetParameterAsDouble("ecal_begin_z");
  ...
  G4cout << "\nDone building TBdchXY05_01" << G4endl;

  return doDch;
  
}

G4bool TBdchXY05_01::DchConstruct(G4LogicalVolume *WorldLog, 
...
void TBdchXY05_01::FetchAll()
{
  ...
  z_placeX1 = db->fetchDouble("z_placeX1");		// -   66 mm
  z_placeX2 = db->fetchDouble("z_placeX2");		// - 1062 mm
  z_placeX3 = db->fetchDouble("z_placeX3");		// - 2139 mm
  z_placeX4 = db->fetchDouble("z_placeX4");		// - 3127 mm
  
  z_placeY1 = db->fetchDouble("z_placeY1");		// -   22 mm
  z_placeY2 = db->fetchDouble("z_placeY2");		// - 1018 mm
  z_placeY3 = db->fetchDouble("z_placeY3");		// - 2095 mm
  z_placeY4 = db->fetchDouble("z_placeY4");		// - 3083 mm
...
void TBdchXY05_01::BuildElements()
{
  ...
  density  = ((1.78e-3)*0.5 + (1.36e-3)*0.5)*g/cm3;
...
G4bool TBdchXY05_01::BuildDchX(G4double x_place, G4double y_place, G4double z_place, G4int idch)
{
...
G4bool TBdchXY05_01::BuildDchY(G4double x_place, G4double y_place, G4double z_place, G4int idch)
{                                     
...
void TBdchXY05_01::SetSD(G4int idch)
{
...
void TBdchXY05_01::SetDepthToLayer(G4int i) {
  depthToLayer = i;
  G4cout <<" DepthToLayer in Dch: " << depthToLayer << G4endl;
}

void TBdchXY05_01::Print()
{
  G4cout << "\nTBdchXY05_01 information: " << G4endl
