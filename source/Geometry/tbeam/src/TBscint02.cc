...
INSTANTIATE(TBscint02)

TBscint02::~TBscint02()
{}

G4bool TBscint02::ContextualConstruct(const CGAGeometryEnvironment &aGeometryEnvironment,
                  G4LogicalVolume *theWorld)
{
 ...
 G4cout << "\nDone building TBscint02" << G4endl;
 return doSci;

}

G4bool TBscint02::SciConstruct(G4LogicalVolume *WorldLog, G4double xdim, G4double ydim,
...
void TBscint02::BuildElements(G4double xdim, G4double ydim)
{
...
G4bool TBscint02::BuildSci(G4double x_place, G4double y_place, G4double z_place,
			   G4int idsc)
{
...
void TBscint02::SetSD(G4int idch)
{
...
void TBscint02::SetDepthToLayer(G4int i) {
  depthToLayer = i;
  G4cout <<" DepthToLayer in Scintillator: " << depthToLayer << G4endl;
}

void TBscint02::Print()
{
  G4cout << "\nTBscint02 information: " << G4endl
