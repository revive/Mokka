...
INSTANTIATE(TBdch03_01)

TBdch03_01::~TBdch03_01()
{}

G4bool TBdch03_01::ContextualConstruct(const CGAGeometryEnvironment &aGeometryEnvironment,
                G4LogicalVolume *theWorld)
{
 ...
 G4cout << "\nDone building TBdch03_01" << G4endl;
 return doDch;

}

G4bool TBdch03_01::DchConstruct(G4LogicalVolume *WorldLog, 
...
G4bool TBdch03_01::BuildDch(G4double x_place, G4double y_place, G4double z_place)
{
...
void TBdch03_01::SetSD(G4int idch)
{
...
void TBdch03_01::SetDepthToLayer(G4int i) {
  depthToLayer = i;
  G4cout <<" DepthToLayer in Dch: " << depthToLayer << G4endl;
}

void TBdch03_01::Print()
{
  G4cout << "\nTBdch03_01 information: " << G4endl
