...
/*================================================================================*/
TBcatcher08::TBcatcher08()
  : VSubDetectorDriver("TBcatcher08","TBcatcher"),
    db(0),
...
/*                                                                                */
/*================================================================================*/
void TBcatcher08::DefineMaterials()
{
  /* materials*/
...
/*                                                                                */
/*================================================================================*/
G4bool TBcatcher08::ContextualConstruct(const CGAGeometryEnvironment &aGeometryEnvironment,
					G4LogicalVolume *WorldLog)
{
  G4cout << G4endl << "\n ======== Driver TBcatcher08 ========" << G4endl;
  ...
  */
  ...
  for (int iLayer = 0; iLayer < n_layers; ++iLayer)
    {
      if (iLayer < n_fine_layers)
        {
          layerThickness = 2. * (air_front_hthickness[iLayer] + readout_module_hthickness + air_back_hthickness[iLayer] + steel_absorber_fine_hthickness);
          absorberThickness = 2. * steel_absorber_fine_hthickness;
        }
      else
        {
          layerThickness = 2. * (air_front_hthickness[iLayer] + readout_module_hthickness + air_back_hthickness[iLayer] + steel_absorber_coarse_hthickness);
  ...
  G4cout << "\n======== Done with driver TBcatcher08 ========" << G4endl;
...
/*                                                                                */
/*================================================================================*/
void TBcatcher08::SetDepthToLayer(G4int i) 
{
  depthToLayer = i;
#ifdef TCMT_DEBUG
...
/*                                                                                */
/*================================================================================*/
G4bool TBcatcher08::BuildCatcher()
{
...
void TBcatcher08::SetSD()
{
  ...
  /*============================================================*/
#ifdef USE_ABSORBER
  catcherSD_steelFront = new TBSD_VCell03("catcherSD_steelFront",
					  GetGridSize(),
					  ncell_xy[0],
					  ncell_xy[1],
					  GetDepthToLayer(),
  ...
  /*-----------------------------------------------------------*/
  catcherSD_steelBack = new TBSD_VCell03("catcherSD_steelBack",
					  GetGridSize(),
					  ncell_xy[0],
					  ncell_xy[1],
					  GetDepthToLayer(),
  ...
  /*-----------------------------------------------------------*/
  catcherSD_steelAbsorberFine = new TBSD_VCell03("catcherSD_steelAbsorberFine",
						 GetGridSize(),
						 ncell_xy[0],
						 ncell_xy[1],
						 GetDepthToLayer(),
  ...
  /*-----------------------------------------------------------*/
  catcherSD_steelAbsorberCoarse = new TBSD_VCell03("catcherSD_steelAbsorberCoarse",
						 GetGridSize(),
						 ncell_xy[0],
						 ncell_xy[1],
						 GetDepthToLayer(),
...
/*                                                                                */
/*================================================================================*/
G4LogicalVolume* TBcatcher08::BuildCoarseLayerLogical(bool withCassette, G4ThreeVector& offset, G4int layerNumber)
{
  ...
  G4Box *CoarseLayerBox    = new G4Box("CoarseLayerBox", 1.20*xlen_tcmt, 1.20*ylen_tcmt, coarse_layer_hthickness[layerNumber]);
  ...
  //G4ThreeVector vplace(0, 0, -coarse_layer_hthickness[layerNumber] + 2*air_front_hthickness[layerNumber] + readout_module_hthickness);
...
/*                                                                                */
/*================================================================================*/
G4LogicalVolume* TBcatcher08::BuildFineLayerLogical(bool withCassette, G4ThreeVector& offset, G4int layerNumber)
{
  G4LogicalVolume *thisLogical = NULL;

#ifdef TCMT_DEBUG
  G4cout<<"\n BuildFineLayerLogical: "<<G4endl;
#endif
  ...
  //G4ThreeVector vplace(0., 0., -fine_layer_hthickness[layerNumber] + 2*air_front_hthickness[layerNumber] + readout_module_hthickness);
...
/*                                                                                */
/*================================================================================*/
G4LogicalVolume* TBcatcher08::BuildReadoutModuleLogical()
{
...
/*                                                                                */
/*================================================================================*/
G4LogicalVolume* TBcatcher08::BuildCatcherEnvelope()
{
...
/*                                                                                */
/*================================================================================*/
void TBcatcher08::BuildCatcherLayers()
{
...
#ifdef TCMT_DEBUG
    G4cout<<"\n Place layer at z = "<<vplace.z()<<G4endl;
#endif
...
/*                                                                                */
/*================================================================================*/
void TBcatcher08::ComputeCatcherTransform()
{
#ifdef TCMT_DEBUG
  G4cout << G4endl << "TBcatcher08::ComputeCatcherTransform()" << G4endl;
#endif
  ...
  // airgap_hthickness_hcal  = 1.25/2.*mm;
...
/*                                                                                */
/*================================================================================*/
G4bool TBcatcher08::PostConstructAction(CGAGeometryEnvironment& )
{
