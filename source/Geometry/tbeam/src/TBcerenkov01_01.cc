...
INSTANTIATE(TBcerenkov01_01)

TBcerenkov01_01::~TBcerenkov01_01()
{}

G4bool TBcerenkov01_01::ContextualConstruct(const CGAGeometryEnvironment &aGeometryEnvironment,
                G4LogicalVolume *theWorld)
{
 ...
 G4cout << "\nBuilding TBcerenkov01_01..." << G4endl;
 ...
 G4cout << "\nDone building TBcerenkov01_01" << G4endl;
 return doCeren;

}

G4bool TBcerenkov01_01::CerenConstruct(G4LogicalVolume *WorldLog, 
...
void TBcerenkov01_01::BuildElements()
{
...
G4bool TBcerenkov01_01::BuildCeren(G4double x_place, G4double y_place, G4double z_place)
{
...
void TBcerenkov01_01::SetSD(G4int iceren)
{
...
void TBcerenkov01_01::SetDepthToLayer(G4int i) {
  depthToLayer = i;
  G4cout <<" DepthToLayer in Cerenkov: " << depthToLayer << G4endl;
}

void TBcerenkov01_01::Print()
{
  G4cout << "\nTBcerenkov01_01 information: " << G4endl
