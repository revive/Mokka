...
INSTANTIATE(TBmuoncount02_01)

TBmuoncount02_01::~TBmuoncount02_01()
{}

G4bool TBmuoncount02_01::ContextualConstruct(const CGAGeometryEnvironment &aGeometryEnvironment,
                  G4LogicalVolume *theWorld)
{
 ...
 G4cout << "\nBuilding TBmuoncount02_01..." << G4endl;
 ...
 G4cout << "\nDone building TBmuoncount02_01" << G4endl;
 return doMC;

}

G4bool TBmuoncount02_01::SciConstruct(G4LogicalVolume *WorldLog, G4double xdim, G4double ydim,
...
void TBmuoncount02_01::FetchAll()
{
...
void TBmuoncount02_01::BuildElements(G4double xdim, G4double ydim)
{
...
G4bool TBmuoncount02_01::BuildSci(G4double x_place, G4double y_place, G4double z_place,
			   G4int idsc)
{
...
void TBmuoncount02_01::SetSD(G4int idch)
{
...
void TBmuoncount02_01::SetDepthToLayer(G4int i) {
  depthToLayer = i;
  G4cout <<" DepthToLayer in Muon Counter: " << depthToLayer << G4endl;
}

void TBmuoncount02_01::Print()
{
  G4cout << "\nTBmuoncount02_01 information: " << G4endl
