...
/*                                                                                */
/*================================================================================*/
G4bool TBhcal4d::ContextualConstruct(const CGAGeometryEnvironment &aGeometryEnvironment,
...
void TBhcal4d::FetchMySQLVariables()
{
  ...
  steel_hthickness = 17.5/2.0; //use one value for all Iron absorber layer.

  if(Hcal_Radiator_Material == "tungsten") {
    isTungstenAbs = true;
    isIronAbs      = false;
    //Hcal_radiator_thickness = _aGeometryEnvironment.GetParameterAsDouble("Hcal_radiator_thickness");
  }  else if(Hcal_Radiator_Material == "Iron") {
    isTungstenAbs = false;
    isIronAbs      = true;
    //Hcal_radiator_thickness = steel_hthickness;
  }  else 
  ...
  */
  ...
  /*The scintillator plane is 900x900 mm^2*/ 
  //HCAL_Layer_X_dimension           = Hcal_cells_size * HCAL_Layer_ncell_x;
  //HCAL_Layer_Y_dimension           = Hcal_cells_size * HCAL_Layer_ncell_y;
  ...
  */
  ...
  for (G4int iLayer = 0; iLayer < HCAL_n_layers; ++iLayer)
	...
	+ cablefibre_mix_hthickness;                   /*cable-fibre mix*/
      ...
      layer_hthickness[iLayer] = poly_hthickness       /*scintillator*/
	+ steel_hthickness                             /*absorber steel s235, 17.5mm*/
	+ 2.0*airgap_hthickness                        /*2 times air gap*/
	+ 2.0*steel_cassette_hthickness                /*2 times steel cassette*/
	+ 2.0*foil_hthickness                          /*2 times 3M foil*/
	+ pcb_hthickness                               /*PCB*/
	+ cablefibre_mix_hthickness;                   /*cable-fibre mix*/
      ...
      AbsLayerLogical[iLayer] = new G4LogicalVolume(AbsLayerSolidW[iLayer], tungstenalloy, 
     ...
     /*create an steel absorber plate */
      ...
      AbsLayerLogical[iLayer]   = new G4LogicalVolume(AbsLayerSolidFe[iLayer], S235, 
						    G4String("HcalAbsLayerLogical") + G4String(stringForLayerNo.str()), 0, 0, 0);
      }
