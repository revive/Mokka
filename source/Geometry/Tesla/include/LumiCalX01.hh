...
class LumiCalX01 : public VSubDetectorDriver
{
  
public:
  LumiCalX01() : VSubDetectorDriver("LumiCalX01","LumiCal"), db(0) {}
  ~LumiCalX01(); 
...
private: 
 ...
 //Some Geometry variables
  ...
  // cell, silicon sectors, tile
  // we have three types of sectors in the tile:
  //  #1 first in tile with dead area at start phi
  //  #2 second and third in tile no dead gap
  //  #3 last in tile with deat gap at end phi
  G4LogicalVolume *CellLogical, *SectorLogical1,*SectorLogical2,*SectorLogical3;  
  ...
  G4Material *air, *silicon, *fanele1, *fanele2, *Al2O3;

 
};

// cell parametrisation class
//
class LcalCellParam : public G4VPVParameterisation
{ 
public:
  LcalCellParam( G4int NoCells, 
                 G4double startR,
		 G4double endR,
                 G4double halfZ,
                 G4double clipSize,
