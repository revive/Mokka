...
// *********************************************************
//
// $Id: VXD02.cc,v 1.8 2008/10/06 12:58:35 musat Exp $
// $Name: mokka-07-00 $
//
// History:
...
G4bool VXD02::construct(const G4String &dbName, G4LogicalVolume *worldLog)
{
...
for (G4double support_loop=0;support_loop<nb_ladder;support_loop++) {
	...
	new G4PVPlacement(rot,
      ...
      thisLadder.distance  = layer_radius - support_structure_thickness;
