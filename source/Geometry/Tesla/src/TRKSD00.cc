...
//*******************************************************
//
// $Id: TRKSD00.cc,v 1.10 2009/04/22 15:23:46 musat Exp $
// $Name: mokka-07-00 $
//
#include "Control.hh"
#include "TRKSD00.hh"
...
TRKSD00::TRKSD00(G4String SDname, 
		 G4double pThreshold,
...
void TRKSD00::Initialize(G4HCofThisEvent *)
{
...
G4bool TRKSD00::ProcessHits(G4Step *aStep,G4TouchableHistory*)
{
...
void 
TRKSD00::EndOfEvent(G4HCofThisEvent*HCE)
{
  if(HCID<0)
...
void 
TRKSD00::LoadEvent(FILE* theSubDetectorEventHitsFileInput)
{
...
void TRKSD00::DrawAll()
{
} 

void TRKSD00::PrintAll()
{
} 

void TRKSD00::DumpHit(G4Step* aStep)
{
...
void TRKSD00::StartNewHit(G4int aLayerNumber,
...
void TRKSD00::UpdateHit(G4Step *aStep)
{
