...
//*******************************************************
//
// $Id: Hcal03.cc,v 1.16 2007/12/21 11:47:26 kristian Exp $
// $Name: mokka-07-00 $
//
// Hcal03.cc
//
...
G4bool 
Hcal03::construct(const G4String &aSubDetectorName,
		  G4LogicalVolume *WorldLog)
{
  ...
  try{
    ...
    G4cout << " WARNING: HCal03: the gear parameters TPC_Ecal_Hcal_barrel_halfZ, " << std::endl 
...
//~              Barrel
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
void Hcal03::Barrel(G4LogicalVolume* MotherLog)
{
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
void Hcal03::BarrelRegularModules(G4LogicalVolume* MotherLog)
{
  // Regular modules
...
void Hcal03::BarrelRegularChambers(G4LogicalVolume* MotherLog,G4double chambers_y_off_correction)
{
...
#ifdef MOKKA_GEAR
	// the GEAR interface code in this driver was backported from
	// Hcal04.cc, which allows for a gap for fibers. Hcal03 does
	// not simulate any gap, so we simply set its thickness to zero
...
//~              Barrel End Modules                 ~
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
void Hcal03::BarrelEndModules(G4LogicalVolume* MotherLog)
{
  // End modules
  // Get parameters
...
void Hcal03::BarrelEndChambers(G4LogicalVolume* MotherLog, 
...
//~              Endcaps                 ~
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
void Hcal03::Endcaps(G4LogicalVolume* MotherLog)
{
...
void Hcal03::EndcapChambers(G4LogicalVolume* MotherLog)
{
  // Chambers in the Hcal03::Endcaps
  ...
  if(SensitiveModel == "scintillator")
	...
	new G4LogicalVolume(EndCapChamberSolid,
      ...
      // Hcal04.cc, which allows for a gap for fibers. Hcal03 does
      // not simulate any gap, so we simply set its thickness to zero
      helpEndcap.sensThickness.push_back( pDz*2 ) ;
...
G4LogicalVolume * 
Hcal03::BuildRPC1Box(G4Box* ChamberSolid, 
		     SD* theSD, 
		     G4int layer_id,
		     G4UserLimits* pULimits)
{
  ...
  Control::Abort("Hcal03::BuildRPC1Box: invalid ChamberSolidEnvelope",MOKKA_OTHER_ERRORS);
  return NULL;
}

G4LogicalVolume * 
Hcal03::BuildRPC1Polyhedra(G4Polyhedra* ChamberSolid, 
			   SD* theSD,
			   G4double phiStart,
			   G4double phiTotal,
			   G4int numSide,
			   ...
			   G4UserLimits* pULimits)
{
  ...
  Control::Abort("Hcal03::BuildRPC1Polyhedra: invalid ChamberSolidEnvelope",MOKKA_OTHER_ERRORS);
  return NULL;  
}

void 
Hcal03::LoadEvent(FILE* theSubDetectorEventHitsFileInput)
{
